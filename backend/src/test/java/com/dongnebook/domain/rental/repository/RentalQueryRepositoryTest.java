...
public class RentalQueryRepositoryTest {
    @Autowired
    ...
    @Test
    public void getRentalByBookIdTest() {
        // given
        Long bookId = 1L;
    ...
    @Test
    public void findAllDeadLineRentalTest() {
        // given
    ...
    public void findAllByMerchantIdOrderByIdDescTest1() {
        ...
        // when
        SliceImpl<RentalBookResponse> rentalBookResponses = rentalQueryRepository.findAllByMerchantIdOrderByIdDesc(merchantId, rentalState, pageRequest);

        // then
        assertThat(rentalBookResponses.hasNext()).isEqualTo(true);
    }
    ...
    public void findAllByMerchantIdOrderByIdDescTest2() {
        ...
        // then
        assertThat(rentalBookResponses.hasNext()).isEqualTo(false);
    }

    @Test
    public void findAllByCustomerIdOrderByIdDesc() {
        // given
        Long customerId = 2L;
        ...
        // when
        SliceImpl<RentalBookResponse> rentalBookResponses = rentalQueryRepository.findAllByCustomerIdOrderByIdDesc(customerId, rentalState, pageRequest);
    ...
    @Test
    public void findAllByCustomerIdOrderByIdDesc2() {
        // given
        Long customerId = 2L;
        String rentalState = (RentalState.TRADING).toString();
        PageRequestImpl pageRequest = PageRequestImpl.of(null);
