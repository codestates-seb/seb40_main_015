...
public class ReservationControllerTest {
    ...
    public void postReservationTest() throws Exception {
        // given
        long bookId = 1L;
        doNothing().when(reservationService).createReservation(Mockito.anyLong(), Mockito.anyLong());
    ...
    public void getReservationsTest() throws Exception {
        ...
        given(reservationService.readReservations(Mockito.anyLong(), Mockito.any(PageRequestImpl.class))).willReturn(sliceImpl);
    ...
    public void deleteReservationTest() throws Exception {
        ...
        doNothing().when(reservationService).cancelReservation(Mockito.anyLong(), Mockito.anyLong());
