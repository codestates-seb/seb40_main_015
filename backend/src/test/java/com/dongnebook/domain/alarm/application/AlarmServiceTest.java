...
class AlarmServiceTest {
	...
	@Test
	void sendAlarmTest() throws Exception {
		// given
		Member member = new Member(1L, "test1", "tester1", new Location(37.5340, 126.7064), "anywhere", "abc1@abc.com");
		Book book = new Book(2L, new BookProduct(), "aaa@abc.com", "기본이 중요", Money.of(1000),
			new Location(37.5340, 126.7064), member);
	...
	@Test
	void getMyAlarmTest() throws Exception {
		// given
		Long memberId = 1L;
	...
	@Test
	void deleteAllByIdTest() throws Exception {
		// given
		Long memberId = 1L;
	...
	@Test
	void AlarmNotFoundExceptionTest() throws Exception {
		// given
		Long memberId = 1L;
		Long alarmId = 1L;
	...
	@Test
	void NotOwnerExceptionTest() throws Exception {
		// given
		Long memberId = 2L;
		Long alarmId = 1L;
	...
	@Test
	void deleteAlarmByIdTest() throws Exception {
		// given
		Long memberId = 1L;
		Long alarmId = 1L;

		Member member = new Member(memberId, "test1", "tester1", new Location(37.5340, 126.7064), "anywhere",
			"abc1@abc.com");
		Book book = new Book(2L, new BookProduct(), "aaa@abc.com", "기본이 중요", Money.of(1000),
			new Location(37.5340, 126.7064), member);
		Alarm alarm = Alarm.create(member, book, AlarmType.RETURN);
	...
	@Test
	void subTest1() throws Exception {
		// given
		Long memberId = 1L;
		String lastEventId = "";
