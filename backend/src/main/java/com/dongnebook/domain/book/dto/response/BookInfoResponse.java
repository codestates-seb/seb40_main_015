...
public class BookInfoResponse {
	...
	public static BookInfoResponse of(Book book) {
		return new BookInfoResponse(book.getId(), book.getImgUrl(), book.getTitle(), book.getAuthor(),
			book.getPublisher(), book.getRentalFee().getValue(), book.getDescription(), book.getLocation(),
